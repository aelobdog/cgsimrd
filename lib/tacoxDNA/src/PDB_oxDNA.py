...
def print_usage():
    print("Usage: python3 %s <pdb_file> 53" % sys.argv[0])
...
if __name__ == '__main__':
    ...
    # print("Using a box of size %g in oxDNA units\n (twice as big as the PDB bounding box size)" % (L), file=sys.stderr)
    ...
    print("Log: oxdna file generated.")
